...
import { ChevronRight, RefreshCcw, ShoppingBag, ArrowRight, Sparkles, Mail, MessageCircle } from 'lucide-react';
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center text-center space-y-8 w-full max-w-2xl mx-auto">
                            ...
                            <div className="relative mt-8 w-full flex flex-col items-center pb-8 border-b-2 sm:border-b-0 border-transparent">
                                <button
                                    ...
                                    className="relative px-10 py-5 sm:px-12 sm:py-6 rounded-2xl flex items-center justify-center min-w-[280px] sm:min-w-[320px] select-none cursor-pointer group mx-auto bg-gradient-to-b from-orange-400 via-orange-500 to-orange-600 shadow-[0_15px_30px_rgba(0,0,0,0.2),0_10px_10px_rgba(234,88,12,0.4),inset_0_3px_2px_rgba(255,255,255,0.6),inset_0_-8px_15px_rgba(0,0,0,0.2),inset_0_1px_1px_rgba(255,255,255,0.2)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.25),0_12px_15px_rgba(234,88,12,0.5),inset_0_3px_2px_rgba(255,255,255,0.7),inset_0_-8px_15px_rgba(0,0,0,0.15)] active:shadow-[0_4px_8px_rgba(0,0,0,0.2),inset_0_6px_10px_rgba(0,0,0,0.3),inset_0_-2px_5px_rgba(255,255,255,0.2)] transition-all duration-150 border border-black/10 text-white hover:-translate-y-1 active:translate-y-1 [text-shadow:0_2px_4px_rgba(0,0,0,0.3)]"
                                >
